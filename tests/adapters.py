...
def run_linear(
    ...
    """
    model=cs336_basics.linear_and_embedding.Linear(d_in,d_out)
...
def run_embedding(
    ...
    """
    model =cs336_basics.linear_and_embedding.Embedding(vocab_size,d_model)
    model.load_state_dict({"W":weights})
...
def run_rmsnorm(
    ...
    """
    model = cs336_basics.rmsnorm.RMSNorm(d_model,eps)
...
def run_cross_entropy(
    ...
    return cs336_basics.cross_entropy.cross_entropy(inputs,targets)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    return cs336_basics.bpe_accelerate.main(input_path,vocab_size,special_tokens)
